        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between text-xs">
              <span className="text-muted-foreground">컴플라이언스 준수율</span>
      ...
      <CardContent className="p-6">
        ...
        {trend && (
          <div className="mt-4 flex items-center gap-2">
            ...
            <span className="text-[11px] text-muted-foreground">vs 지난 달</span>
          </div>
        )}
      </CardContent>
    </Card>
        ...
        <div className="flex items-end justify-between">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {mandatoryCount}개 필수 항목 중 {completedCount}개 이행 완료
            </p>
          </div>
          <div className={cn(
      ...
      <CardFooter className="pt-0">
        <div className="w-full grid grid-cols-2 gap-2">
          ...
          <div className="flex items-center gap-1.5 text-[11px] text-muted-foreground bg-secondary/50 p-2 rounded">
            ...
            <span>{mandatoryCount - completedCount}개 항목 검토 필요</span>
          </div>
        </div>
      </CardFooter>
    </Card>
