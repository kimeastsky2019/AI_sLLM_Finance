      ...
      <header className="fixed top-0 left-0 right-0 h-16 bg-background/80 backdrop-blur-md border-b border-border z-50 flex items-center justify-between px-4 lg:px-6">
        <div className="flex items-center gap-4">
          ...
          <Link to={ROUTE_PATHS.HOME} className="flex items-center gap-3 group">
            <img src={gngLogo} alt="GnG International Logo" className="h-8 w-auto object-contain" />
            <div className="flex flex-col">
              <span className="font-bold text-lg leading-none tracking-tight text-[#0B1C3E] dark:text-white">GnG International</span>
              <span className="text-[10px] text-muted-foreground font-medium uppercase tracking-widest">Global Data Solution</span>
            </div>
          </Link>
        </div>
              ...
              >
                <div className="flex items-center justify-between mb-8">
                  <Link to={ROUTE_PATHS.HOME} className="flex items-center gap-2">
                    <img src={gngLogo} alt="GnG International Logo" className="h-8 w-auto object-contain" />
                    <span className="font-bold text-[#0B1C3E] dark:text-white">GnG International</span>
                  </Link>
